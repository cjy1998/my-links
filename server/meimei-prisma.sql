...
CREATE TABLE `sys_dept` (
  ...
  CONSTRAINT `sys_dept_parentId_fkey` FOREIGN KEY (`parentId`) REFERENCES `sys_dept` (`deptId`) ON DELETE
...
CREATE TABLE `sys_dict_data` (
  ...
  CONSTRAINT `sys_dict_data_dictType_fkey` FOREIGN KEY (`dictType`) REFERENCES `sys_dict_type` (`dictType`) ON DELETE
  SET NULL ON UPDATE CASCADE
...
CREATE TABLE `sys_menu` (
  ...
  CONSTRAINT `sys_menu_parentId_fkey` FOREIGN KEY (`parentId`) REFERENCES `sys_menu` (`menuId`) ON DELETE
  SET NULL ON UPDATE CASCADE
...
CREATE TABLE `sys_user` (
  ...
  CONSTRAINT `sys_user_deptId_fkey` FOREIGN KEY (`deptId`) REFERENCES `sys_dept` (`deptId`) ON DELETE
  SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 3 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
INSERT INTO `meimei-prisma`.`_prisma_migrations` (
    `id`,
    `checksum`,
    `finished_at`,
    `migration_name`,
...
VALUES (
    '144e3f5c-f31c-4be6-9e80-edc9f39f7ad0',
    'abfd123be42ce01a6dd33bc847f5e9ba7a8f8f10de1a8ca1ad15d85bc9fc7b6d',
    '2025-06-29 13:18:52.467',
    '20250629131852_init',
    NULL,
    NULL,
    '2025-06-29 13:18:52.212',
    1
  ),
(
    '1fbf4e6d-c11b-42b9-aa55-b6fbc940b89b',
    '632b8f82bc6c00aeab141a2309bd072e8d5d1ad4535428ef1df36751aaab25ff',
    '2025-06-29 13:37:00.824',
    '20250629133700_add_sysflie',
    NULL,
    NULL,
    '2025-06-29 13:37:00.818',
    1
  );
UNLOCK TABLES;
COMMIT;
...
INSERT INTO `meimei-prisma`.`_sys_dept_to_sys_role` (`A`, `B`)
VALUES (100, 1);
UNLOCK TABLES;
COMMIT;
BEGIN;
...
INSERT INTO `meimei-prisma`.`_sys_role_to_sys_user` (`A`, `B`)
VALUES (1, 1);
UNLOCK TABLES;
COMMIT;
BEGIN;
...
INSERT INTO `meimei-prisma`.`sys_config` (
    `configId`,
    `configName`,
    `configKey`,
    `configValue`,
...
INSERT INTO `meimei-prisma`.`sys_dept` (
    `deptId`,
    `parentId`,
    `ancestors`,
    `deptName`,
...
INSERT INTO `meimei-prisma`.`sys_dict_data` (
    `dictCode`,
    `dictSort`,
    `dictLabel`,
    `dictValue`,
...
INSERT INTO `meimei-prisma`.`sys_dict_type` (
    `dictId`,
    `dictName`,
    `dictType`,
    `status`,
...
INSERT INTO `meimei-prisma`.`sys_job` (
    `jobId`,
    `jobName`,
    `jobGroup`,
    `invokeTarget`,
...
INSERT INTO `meimei-prisma`.`sys_job_log` (
    `jobLogId`,
    `jobName`,
    `jobGroup`,
    `invokeTarget`,
...
INSERT INTO `meimei-prisma`.`sys_login_infor` (
    `infoId`,
    `userName`,
    `ipaddr`,
    `loginLocation`,
...
INSERT INTO `meimei-prisma`.`sys_menu` (
    `menuId`,
    `menuName`,
    `parentId`,
    `orderNum`,
...
INSERT INTO `meimei-prisma`.`sys_notice` (
    `noticeId`,
    `noticeTitle`,
    `noticeType`,
    `noticeContent`,
...
VALUES (
    ...
    '测试一个小公告',
    '1',
    0x3C703EE6B58BE8AF95E4B880E4B88BE585ACE5918A2E2E2E2E2E2020203C2F703E,
    '0',
    'admin',
    '2024-05-17 13:50:01',
    '',
...
INSERT INTO `meimei-prisma`.`sys_oper_log` (
    `operId`,
    `title`,
    `businessType`,
    `method`,
...
(
    ...
    '系统参数',
    '3',
    'SysConfigController.delete()',
    'DELETE',
    0,
    'admin',
    '研发部门',
    '/system/config/1,3,5,6',
    '127.0.0.1',
    '内网IP',
    '{\"params\":{\"configIds\":\"1,3,5,6\"},\"query\":{},\"body\":{}}',
    '{\"code\":200,\"msg\":\"操作成功\"}',
    '0',
    NULL,
    '2024-05-17 13:47:25',
...
(
    ...
    '127.0.0.1',
    '内网IP',
    '{\"params\":{},\"query\":{},\"body\":{\"menuId\":115,\"menuName\":\"表单构建\",\"parentId\":3,\"orderNum\":1,\"path\":\"build\",\"component\":\"tool/build/index\",\"query\":null,\"isFrame\":\"1\",\"isCache\":\"0\",\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"1\",\"perms\":\"tool:build:list\",\"icon\":\"build\",\"createBy\":\"admin\",\"createTime\":\"2024-04-18T16:07:17.000Z\",\"updateBy\":\"\",\"updateTime\":null,\"remark\":\"表单构建菜单\"}}',
    '{\"code\":200,\"msg\":\"操作成功\"}',
    '0',
    NULL,
    '2024-05-17 13:51:17',
...
(
    ...
    '127.0.0.1',
    '内网IP',
    '{\"params\":{},\"query\":{},\"body\":{\"menuId\":116,\"menuName\":\"代码生成\",\"parentId\":3,\"orderNum\":2,\"path\":\"gen\",\"component\":\"tool/gen/index\",\"query\":null,\"isFrame\":\"1\",\"isCache\":\"0\",\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"1\",\"perms\":\"tool:gen:list\",\"icon\":\"code\",\"createBy\":\"admin\",\"createTime\":\"2024-04-18T16:07:17.000Z\",\"updateBy\":\"\",\"updateTime\":null,\"remark\":\"代码生成菜单\"}}',
    '{\"code\":200,\"msg\":\"操作成功\"}',
    '0',
    NULL,
    '2024-05-17 13:51:22',
...
(
    ...
    '127.0.0.1',
    '内网IP',
    '{\"params\":{},\"query\":{},\"body\":{\"menuId\":117,\"menuName\":\"系统接口\",\"parentId\":3,\"orderNum\":3,\"path\":\"swagger\",\"component\":\"tool/swagger/index\",\"query\":null,\"isFrame\":\"1\",\"isCache\":\"0\",\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"1\",\"perms\":\"tool:swagger:list\",\"icon\":\"swagger\",\"createBy\":\"admin\",\"createTime\":\"2024-04-18T16:07:17.000Z\",\"updateBy\":\"\",\"updateTime\":null,\"remark\":\"系统接口菜单\"}}',
    '{\"code\":200,\"msg\":\"操作成功\"}',
    '0',
    NULL,
    '2024-05-17 13:51:28',
...
(
    ...
    '127.0.0.1',
    '内网IP',
    '{\"params\":{},\"query\":{},\"body\":{\"menuId\":3,\"menuName\":\"系统工具\",\"parentId\":0,\"orderNum\":3,\"path\":\"tool\",\"component\":null,\"query\":null,\"isFrame\":\"1\",\"isCache\":\"0\",\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"1\",\"perms\":null,\"icon\":\"tool\",\"createBy\":\"admin\",\"createTime\":\"2024-04-18T16:07:17.000Z\",\"updateBy\":\"\",\"updateTime\":null,\"remark\":\"系统工具目录\"}}',
    '{\"code\":200,\"msg\":\"操作成功\"}',
    '0',
    NULL,
    '2024-05-17 13:51:32',
...
(
    ...
    '127.0.0.1',
    '内网IP',
    '{\"params\":{},\"query\":{},\"body\":{\"menuId\":3,\"menuName\":\"系统工具\",\"parentId\":0,\"orderNum\":3,\"path\":\"tool\",\"component\":null,\"query\":null,\"isFrame\":\"1\",\"isCache\":\"0\",\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"0\",\"perms\":null,\"icon\":\"tool\",\"createBy\":\"admin\",\"createTime\":\"2024-04-18T16:07:17.000Z\",\"updateBy\":\"admin\",\"updateTime\":\"2024-05-17T13:51:31.000Z\",\"remark\":\"系统工具目录\"}}',
    '{\"code\":200,\"msg\":\"操作成功\"}',
    '0',
    NULL,
    '2024-05-17 13:51:41',
...
(
    ...
    '127.0.0.1',
    '内网IP',
    '{\"params\":{},\"query\":{},\"body\":{\"menuId\":3,\"menuName\":\"系统工具\",\"parentId\":0,\"orderNum\":3,\"path\":\"tool\",\"component\":null,\"query\":null,\"isFrame\":\"1\",\"isCache\":\"0\",\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"1\",\"perms\":null,\"icon\":\"tool\",\"createBy\":\"admin\",\"createTime\":\"2024-04-18T16:07:17.000Z\",\"updateBy\":\"admin\",\"updateTime\":\"2024-05-17T13:51:40.000Z\",\"remark\":\"系统工具目录\"}}',
    '{\"code\":200,\"msg\":\"操作成功\"}',
    '0',
    NULL,
    '2024-05-17 13:51:44',
...
(
    ...
    '127.0.0.1',
    '内网IP',
    '{\"params\":{},\"query\":{},\"body\":{\"menuId\":115,\"menuName\":\"表单构建\",\"parentId\":3,\"orderNum\":1,\"path\":\"build\",\"component\":\"tool/build/index\",\"query\":null,\"isFrame\":\"1\",\"isCache\":\"0\",\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"0\",\"perms\":\"tool:build:list\",\"icon\":\"build\",\"createBy\":\"admin\",\"createTime\":\"2024-04-18T16:07:17.000Z\",\"updateBy\":\"admin\",\"updateTime\":\"2024-05-17T13:51:17.000Z\",\"remark\":\"表单构建菜单\"}}',
    '{\"code\":200,\"msg\":\"操作成功\"}',
    '0',
    NULL,
    '2024-05-17 13:51:50',
...
(
    ...
    '127.0.0.1',
    '内网IP',
    '{\"params\":{},\"query\":{},\"body\":{\"menuId\":3,\"menuName\":\"系统工具\",\"parentId\":0,\"orderNum\":3,\"path\":\"tool\",\"component\":null,\"query\":null,\"isFrame\":\"1\",\"isCache\":\"0\",\"menuType\":\"M\",\"visible\":\"0\",\"status\":\"1\",\"perms\":null,\"icon\":\"tool\",\"createBy\":\"admin\",\"createTime\":\"2024-04-18T16:07:17.000Z\",\"updateBy\":\"admin\",\"updateTime\":\"2024-05-17T13:51:44.000Z\",\"remark\":\"系统工具目录\"}}',
    '{\"code\":500,\"msg\":\"该菜单下存在其他正在使用的菜单，无法停用！\"}',
    '1',
    '该菜单下存在其他正在使用的菜单，无法停用！',
    '2024-05-17 13:57:15',
    174
  ),
(
    ...
    '127.0.0.1',
    '内网IP',
    '{\"params\":{},\"query\":{},\"body\":{\"menuId\":115,\"menuName\":\"表单构建\",\"parentId\":3,\"orderNum\":1,\"path\":\"build\",\"component\":\"tool/build/index\",\"query\":null,\"isFrame\":\"1\",\"isCache\":\"0\",\"menuType\":\"C\",\"visible\":\"0\",\"status\":\"1\",\"perms\":\"tool:build:list\",\"icon\":\"build\",\"createBy\":\"admin\",\"createTime\":\"2024-04-18T16:07:17.000Z\",\"updateBy\":\"admin\",\"updateTime\":\"2024-05-17T13:51:50.000Z\",\"remark\":\"表单构建菜单\"}}',
    '{\"code\":200,\"msg\":\"操作成功\"}',
    '0',
    NULL,
    '2024-05-17 13:57:27',
...
INSERT INTO `meimei-prisma`.`sys_post` (
    `postId`,
    `postCode`,
    `postName`,
    `postSort`,
...
INSERT INTO `meimei-prisma`.`sys_role` (
    `roleId`,
    `createBy`,
    `createTime`,
    `dataScope`,
...
INSERT INTO `meimei-prisma`.`sys_user` (
    `userId`,
    `avatar`,
    `createBy`,
    `createTime`,
...
VALUES (
    ...
    '',
    '小蒋',
    '$2b$10$dfDByASRziLltpJ9OQ8cTuSeaz3Kqv.BR1MWQoQ1bR3UfgEKYE0w6',
    '15888888888',
    '管理员',
    '1',
    '0',
...
(
    ...
    '',
    '槑槑',
    '$2b$10$eOA3TW08QKta3zRSlhY6f.RXnOuzDwM0OGWAYh8zwVYMFwCkF.dme',
    '15666666666',
    '测试员',
    '1',
    '0',
